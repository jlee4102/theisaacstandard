...
export default function GoveeSmartLedStripReview() {
  const jsonLd = {
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Brightness is adequate for accent lighting, not room illumination. The manufacturer claims 1900 lumens per meter, but that&apos;s per meter of strip, not total output. In practice, it&apos;s enough