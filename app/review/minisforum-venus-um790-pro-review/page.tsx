...
export default function Page() {
  ...
  return (
    <article className="prose-isaac max-w-3xl mx-auto px-6 md:px-10 py-10">
      ...
      <p>The Ryzen 9 7940HS is a beast. In multi-core workloads it performs roughly on par with a desktop Ryzen 7 5700X. That means it can handle video transcoding, 4K editing, and even some light 3D rendering without breaking a sweat. The Radeon 780M iGPU is the real star: it runs Fortnite at 1080p High with a steady 60 fps, and even Cyberpunk 2077 at 1080p Low hits 30-40 fps. For an integrated GPU, that&apos;s remarkable.</p>
      <p>But there&apos;s a catch: sustained loads cause the fan to spin up to a noticeable whine, and the chassis gets hot to the touch on the top panel. While it never throttled in my testing, the noise might be annoying in a quiet office or bedroom. If you plan to run CPU-heavy tasks for hours, consider undervolting or a better cooling pad.</p>
